...
public class ConveniencePayService {    //편결이
    ...
    public PayCancleResponse payCancel(PayCancelRequest payCancelRequest) {
        ...
        if(cancelPaymentResult == cancelPaymentResult.CANCEL_PAYMENT_FAIL) {
            return new PayCancleResponse(PayCancelResult.PAY_CANCEL_FAIL, 0);
        }

        // Success Case
        return new PayCancleResponse(PayCancelResult.PAY_CANCEL_SUCCESS, payCancelRequest.getPayCancelAmount());
    }
}
