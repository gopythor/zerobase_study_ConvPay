...
class DiscountedByMethodTest {
    DiscountedByMethod discountedByMethod = new DiscountedByMethod();
    ...
    @Test
        ...
        Integer discountedAmountMoney =
                discountedByMethod.getDiscountedAmount(payRequestMoney);
        Integer discountedAmountCard =
                discountedByMethod.getDiscountedAmount(payRequestCard);
